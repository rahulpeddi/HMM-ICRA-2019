...
\end{equation}
where $v_q\in v_q^p$ and $\delta$ refers to a sampling time. With this \NB{avoid these expressions} we obtain future forward positions:
\begin{equation}
...
Risk is a function of $d_q(t)$ \NB{and he lane} such that risk increases as distance decreases and is calculated as follows:

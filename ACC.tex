...
\begin{subfigure}{\linewidth}
    ...
    \caption{The error between the velocity of the actual model and estimated velocities}
    \label{fig:trainvel}
\end{subfigure}
\begin{subfigure}{\linewidth}
    \centering
    \includegraphics[width=\linewidth]{fig/trainposerror.png}
    \caption{The error between the position of the actual model and estimated positions}
    \label{fig:trainpos}
\end{subfigure}

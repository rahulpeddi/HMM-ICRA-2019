...
Using these future velocities, we can calculate the positions of $q$ over the horizon $H$ as $x_q(t) = v_q(t)\delta t$ where $v_q\in V_q$, and obtain future forward positions:
\begin{equation}

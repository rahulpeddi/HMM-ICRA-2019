...
The specific environment we are studying involves multiple lanes with multiple vehicles that can change their velocities and their lanes. Within this environment, we implement the framework twice to capture the behaviors we expect to see. The framework is applied to all of the vehicles, $q$ in our sensing range $R_h$.

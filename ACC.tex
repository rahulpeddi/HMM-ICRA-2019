...
\begin{subfigure}{\linewidth}
    ...
    \caption{The error of the fit between the current vehicle and each of the three pretrained models}
    \label{fig:error}
\end{subfigure}
\begin{subfigure}{\linewidth}
    \includegraphics[width=\linewidth]{fig/trustfit.png}
    \caption{The trust associated with the best-fit model at each iteration}
    \label{fig:trust}
\end{subfigure}
\begin{subfigure}{\linewidth}
    \includegraphics[width=\linewidth]{fig/modelselect.png}
    \caption{The selected model at each iteration}
    \label{fig:select}
\end{subfigure}

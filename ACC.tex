...
[insert proof here where we prove that this always leads to the safest condition - we guarantee that the user action is guaranteed to produce the lowest attainable risk, assuming predictions are correct.

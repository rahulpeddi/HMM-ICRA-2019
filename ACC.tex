...
\begin{subfigure}{.46\linewidth}
  ...
  \label{fig:critptrs}
\end{subfigure}
\caption{Critical Point - Risk Distribution and Road Scenario} \label{fig:noassist}
\end{figure}
...
\begin{subfigure}{.46\linewidth}
  ...
  \label{fig:assistrs}
\end{subfigure}
\caption{Assisted Control - Risk Distribution and Road Scenario} \label{fig:assist}
\end{figure}

...
% give a configuration if there exists a safe trajectory and if risk is above the trheshold, the approach in .... guarantees that the system is always going to be safe..this is a probabilitic guarantee
